...
class MimiModel(CompressionModel[_MimiState]):
    ...
    def _encode_to_unquantized_latent(self, x: torch.Tensor) -> torch.Tensor:
        ...
        emb = self._to_framerate(emb)  # bsz d seqlen -> bsz d seqlen/2
        return emb
    ...
    def _decode_from_unquantized_latent(self, emb: torch.Tensor) -> torch.Tensor:
        """Projects a batch of unquantized latent space to waveform.
